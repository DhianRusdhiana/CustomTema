  ...
  void init(Context context, AttributeSet attributeSet) {
	  ...
	  context.registerReceiver((BroadcastReceiver) new BroadcastReceiver() {
											 ...
											 public void onReceive(Context context2, Intent intent) {
												 warna = intent.getIntExtra("warnaTema", Utils.setColor());
												 mColorNormal = warna;
												 updateBackground();
												 prefs = context2.getSharedPreferences(prefName, context2.MODE_PRIVATE);
												 SharedPreferences.Editor editor = prefs.edit();
												 editor.putInt("warna", warna);
												 editor.commit();
											 }
    ...
    mColorNormal = warna;
	  mColorPressed = replaceHue(warna,3.0f);
	...
	private int replaceHue(int color, float factor) {
